 ...
 * appended as new leaves. New panels STACK VERTICALLY (col) by default: the
 * details column is narrow, so side-by-side rows make every panel unreadable.
 * Users can still drag to create row splits explicitly.
