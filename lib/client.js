...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function TabsContainer(props) {
			...
			if (activeKey !== null) {
				try {
					const rendered = renderSlot("details.tabs.item", {}, { entryKey: activeKey });
					...
					// nothing (strict-session-absent) — e.g. the artifacts panel
					// came up blank. SessionProvider takes a children(id) function.
					content = typeof SessionProvider === "function"
